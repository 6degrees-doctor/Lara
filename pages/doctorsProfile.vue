    ...
    <div>
         ...
         <div class=" bg-color container px-5 py-4 my-5">
                        <div class="row ">
                         <div class="col">
                        <div class="mb-3 ">
                            <h2 class="fw-bold">Pending Reviews</h2>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body ">
                            ...
                            <button type="submit" class="btn btn-color">Accept <i class="bi bi-check2"></i></button>
                            <button type="submit" class="btn btn-color">Reject <i class="bi bi-x-lg"></i></button>
                            </div>
                        </div>
                        </div>
                    </div>
